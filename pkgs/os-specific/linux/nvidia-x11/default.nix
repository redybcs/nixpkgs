...
rec {
  ...
  production = generic {
    ...
    settingsSha256 = lib.fakeHash; # "sha256-AtzYTz7kbmj3vxmBQTC0eAjM3b2I259y1tdxq90n9YU=";
    persistencedSha256 = lib.fakeHash; # "sha256-WL57kKFWeRW0oPktp6afkUb5Om9MCGAvKWctk5yiyIA=";
  };
